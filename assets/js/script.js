...
const projects = [
    {src: './assets/img/projects/fortfolio.png', description: 'Fortfolio: is a web page for a webDev deploy you own projects, based on HBS, CSS, JavaScript for frontend, in the backend using Nodejs, Express, MongoDB as a database.', gitRepo:'https://github.com/TahaRafaLinoOrg/project2', deployLink:'https://project-portfolio.adaptable.app/'},
