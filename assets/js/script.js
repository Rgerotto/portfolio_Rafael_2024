...
const projects = [
    ...
    {src: './assets/img/projects/projectPizzaria.avif', description: 'In this project, I expanded my knowledge of React by applying advanced techniques and industry best practices, including Redux for state management, REST API integration, and optimized component organization. This project was completed as part of a comprehensive Udemy course that challenged me to refine my skills and develop maintainable, scalable React applications.', gitRepo: 'https://github.com/Rgerotto/fast-pizza-project', deployLink: 'https://project-pizzaria.netlify.app/'},
    ...
    {src: './assets/img/projects/nexter.avif', description: 'Nexter: project from Udemy CSS Master to improve CSS grid', gitRepo: 'https://github.com/Rgerotto/nexter', deployLink: 'https://nexter-homes-luxury.netlify.app/'},
